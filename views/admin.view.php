		...
		<div class="full-box text-center" style="padding: 30px 10px;">
			<article class="full-box tile">
				...
				<div class="full-box tile-number text-titles">
					<p class="full-box">
						<?php require "admin/dbconfig.php";$query ="SELECT * FROM usuarios WHERE tipo_usuario = 'administrador'";$query_run = mysqli_query($connection, $query);$row = mysqli_num_rows($query_run);echo "<h1>".$row."</h1>"?>
					</p>
			...
			<article class="full-box tile">
				...
				<div class="full-box tile-number text-titles">
					<p class="full-box">
						<?php require "admin/dbconfig.php";$query ="SELECT * FROM usuarios WHERE tipo_usuario = 'profesor'";$query_run = mysqli_query($connection, $query);$row = mysqli_num_rows($query_run);echo "<h1>".$row."</h1>"?>
					</p>
					<small>Register</small>
				</div>
			</article>
			<article class="full-box tile">
				...
				<div class="full-box tile-number text-titles">
					<p class="full-box">
						<?php require "admin/dbconfig.php";$query ="SELECT * FROM usuarios WHERE tipo_usuario = 'usuario'";$query_run = mysqli_query($connection, $query);$row = mysqli_num_rows($query_run);echo "<h1>".$row."</h1>"?>
					</p>
					<small>Register</small>
				</div>
			</article>
