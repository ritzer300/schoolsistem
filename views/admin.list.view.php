		...
		<div class="container-fluid">
			<ul class="breadcrumb breadcrumb-tabs">
				<li>
			  	...
			  	<li>
			  		<a href="nuevo.admin.php" class="btn btn-info">
			...
			<div class="panel panel-success">
				...
				foreach ($usuarios as $dato) {
					...
					<tr>
						...
						<td><a class="btn btn-success btn-raised btn-xs" href="admin.act.php?id=<?php echo $dato->id; ?>"><i class="zmdi zmdi-refresh"></i></a></td>
						<td><a class="btn btn-danger btn-raised btn-xs" href="eliminar.php?id=<?php echo $dato->id; ?>"><i class="zmdi zmdi-delete"></i></a></td>
					</tr>
					<?php
					}
				?>
